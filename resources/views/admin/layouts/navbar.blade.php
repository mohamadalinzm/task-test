<nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block my-2">
{{--            <a href="{{ route('admin') }}" class="nav-link">تماس</a>--}}
            <span style="color: #2fa360;" class="mx-3 my-5"> قیمت روز طلا : {{ \App\Setting::whereOption_name('dayPrice')->first()->option_value }}</span>
        </li>
    </ul>
    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
            <a class="btn btn-sm btn-danger" href="{{ route('admin.logout') }}"> خروج </a>
        </li>
